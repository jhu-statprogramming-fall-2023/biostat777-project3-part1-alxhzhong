...
The data dictionary for `weather_forecasts.csv` can be found [here](https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/2022-12-20#weather_forecastscsv), that for `cities.csv` can be found [here](https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/2022-12-20#citiescsv).
...
We'll use the `usmap` package to map forecast error in the US (while including Alaska dna Hawaii).
...
load(file = here("data", "raw_cities.rda"))
```
